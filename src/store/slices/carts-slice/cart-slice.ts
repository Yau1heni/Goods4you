...
export const slice = createSlice({
    ...
    reducers: {
        ...
        addProduct(state, action: PayloadAction<{ product: CartProduct, isFromDraft?: boolean }>) { // ?????UPDATEDPRODUCT или нет
            if (state.carts !== null) {
...
export const addProductToCart = createMainAsyncThunk<Cart, { product: CartProduct, isFromDraft?: boolean }>(
